...
```
![본인 사진](./내사진.jpg)
![본인 사진](./내사진.jpg "부산에서 찍은 사진예")

사이즈 조절 기능은 없기 때문에 ```<img width="" height=""></img>```를 이용한다.

예
```
<img src="/path/to/img.jpg" width="450px" height="300px" title="px(픽셀) 크기 설정" alt="busan"></img><br/>
<img src="/path/to/img.jpg" width="40%" height="30%" title="px(픽셀) 크기 설정" alt="busan"></img>
```

<img src="내사진.jpg" width="450px" height="300px" title="px(픽셀) 크기 설정" alt="busan"></img><br/>
<img src="내사진.jpg" width="40%" height="30%" title="%(비율) 크기 설정" alt="busan"></img>
...
# 5. 이모지, 뱃지 만드는 url 정보
간단한 이모지를 확인 할 수 있는 사이트  
:+1: :sparkles: :camel: :tada: :rocket: :metal: :octocat:
[이모지](https://www.webfx.com/tools/emoji-cheat-sheet/ "emoji")  

배지(badge)를 만들 수 있는 사이트  
<a href="https://github.com/whddnjs117"><img src="https://img.shields.io/badge/github-my-green"></a>
[배지](https://shields.io/ "badge")
*****
